...
{
    public partial class DanhSachQuanTri : UserControl
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            int stt = 1;
            foreach (var x in new DAO.SqlToLinq.Admin().getAll().Where(x => x.Status == 1 && (x.MaAdmin.ToLower().Contains(textBox1.Text.ToLower())
        ...
        {
            var TTK = new View.QuanLyTaiKhoan.ThemTaiKhoan(3);
