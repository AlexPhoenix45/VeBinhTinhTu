namespace View.QuanLyMuonTra.QuanLyMuon
{
    partial class ChiTietPhieuMuon
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnBtn = new Panel();
            btnTao = new Button();
            txtGhiChuTra = new TextBox();
            label12 = new Label();
            txtNgayMuon = new TextBox();
            label11 = new Label();
            txtTongPhi = new TextBox();
            label10 = new Label();
            txtPhatHong = new TextBox();
            label9 = new Label();
        ...
        private TextBox txtGhiChuTra;
        private TextBox txtTongPhi;
        private TextBox txtPhatHong;
